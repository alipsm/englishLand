...
export default function Index({
  ...
  tryingToFindTranslateWord = (value:string) =>{return false}, // checking correct translation
  ...
  languageCardData = {
    ...
    trying: 4 as number,
    finishGame: { end: false as boolean, win: false as boolean |undefined}
  },
          ...
          <div
            ...
            <div className="h-[50%] overflow-y-auto">
              <p className="meanings fle x pr-3 justify-evenly">
                {languageCardData.finishGame.end &&
                  languageCardData.persianMeanings.map((meaning: string,index) => (
            ...
            <div className="h-[20%] overflow-y-auto">
              ...
              (languageCardData.examples?.length != 0 && showingExample) ? (
                languageCardData.examples?.map((example: string,index) => (
                  <p className="examples animate__animated animate__fadeIn" key={index}>
                    {example}
                  </p>
                ))
              ) : (
            ...
            <img
                      ...
                      className={`inset-auto object-cover relative h-full  cursor-pointer animate__animated ${languageCardAnimation.arrow}   animate__delay-1s`}
                    />
              {/* <img
                src={ImageContainer.arrow.img}
                alt={ImageContainer.arrow.alt}
